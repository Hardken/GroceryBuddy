...
public class DetalleProductoActiviy extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalle_producto_activiy);
                                    ...
                                    db.collection("producto")
                                            ...
                                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                ...
                                                public void onSuccess(Void unused) {
                                                    Toast.makeText(DetalleProductoActiviy.this, "Eliminado correctamente", Toast.LENGTH_SHORT).show();
                                                }
                                            }).addOnFailureListener(new OnFailureListener() {
                                                @Override
                                                public void onFailure(@NonNull Exception e) {
                                                    Toast.makeText(DetalleProductoActiviy.this, "Error no se ha eliminado correctamente", Toast.LENGTH_SHORT).show();

                                                }
                                            });
                                }else{
                                    Toast.makeText(DetalleProductoActiviy.this, "ERROR", Toast.LENGTH_SHORT).show();
