...
public class PerfilActivityadmin extends AppCompatActivity {
    private ImageView imageView;
    private EditText usr_nombre;
    private EditText usr_correo;
    private EditText usr_cuenta;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        usr_cuenta=findViewById(R.id.edt_usr_cuenta);
        ...
        if(usrdata != null){
            ...
            try {
                ...
                correo = usuario.getString("correo");
                cuenta = Double.parseDouble(usuario.getString("cuenta"));

                usr_nombre.setText(nombre);
                usr_cuenta.setText(String.valueOf(cuenta));
...
/*        slecimg.setOnClickListener(new View.OnClickListener() {
        ...
        usave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                }else if (newcuenta.isEmpty()){
                    usr_cuenta.setError("Por favor introduce una cuenta");
                    usr_cuenta.requestFocus();
                }else if (newcorreo.isEmpty()){
                    usr_correo.setError("Por favor introduce un correo");
                                        ...
                                        db.collection("usuarios")
                                                ...
                                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                    ...
                                                    public void onSuccess(Void unused) {
                                                        ...
                                                        usr_correo.setText("");
                                                        usr_cuenta.setText("");
                                                        Toast.makeText(PerfilActivityadmin.this, "Actualizacion Correcta", Toast.LENGTH_SHORT).show();

                                                    }
                                                }).addOnFailureListener(new OnFailureListener() {
                                                    @Override
                                                    public void onFailure(@NonNull Exception e) {
                                                        Toast.makeText(PerfilActivityadmin.this, "Error: no se pudo hacer actualizacion", Toast.LENGTH_SHORT).show();

                                                    }
                                                });
                                    }else{
                                        Toast.makeText(PerfilActivityadmin.this, "Error", Toast.LENGTH_SHORT).show();
                                    }
                                ...
                                if (task.isSuccessful() && !task.getResult().isEmpty()){
                                    ...
                                    db.collection("usuarios")
                                            ...
                                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                @Override
                                                public void onSuccess(Void unused) {
                                                    Toast.makeText(PerfilActivityadmin.this, "Eliminado correctamente", Toast.LENGTH_SHORT).show();
                                                }
                                            }).addOnFailureListener(new OnFailureListener() {
                                                @Override
                                                public void onFailure(@NonNull Exception e) {
                                                    Toast.makeText(PerfilActivityadmin.this, "Error no se ha eliminado correctamente", Toast.LENGTH_SHORT).show();
    ...
    public void subirImagen(){
        ...
        if (data1 != null) {
            ...
            final ProgressDialog progressDialog = new ProgressDialog(PerfilActivityadmin.this);
            ...
            mispreferencias = PerfilActivityadmin.this.getSharedPreferences(Constant.PREFERENCE, MODE_PRIVATE);
            ...
            riversRef.putFile(data1)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(PerfilActivityadmin.this, "File Uploaded ", Toast.LENGTH_LONG).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception exception) {
                            ...
                            Toast.makeText(PerfilActivityadmin.this, exception.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    })
        ...
        //if there is not any file
            ...
            Toast.makeText(PerfilActivityadmin.this, "Error", Toast.LENGTH_LONG).show();
        }
    }*/
}