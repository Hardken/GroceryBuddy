...
public class MenuActivityuser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intent = new Intent(MenuActivityuser.this, MenuActivityuser.class);
        ...
        binding.appBarMenu.fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Navigation.findNavController(miactividad, R.id.nav_host_fragment).navigate(R.id.nav_producto);
                    Navigation.findNavController(miactividad2, R.id.nav_host_fragment_content_menu).navigate(R.id.nav_producto);
...
/*
                ...
                if (id==R.id.nav_salir){
                    ...
                    Intent intent = new Intent(miactividad2, LoginActivity.class);
                    startActivity(intent);
                    player = MediaPlayer.create(MenuActivityuser.this,R.raw.mepicanloscocos);
                    player.start();
            ...
            riversRef.putFile(data1)
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception exception) {
                            ...
                            Toast.makeText(miactividad2, exception.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    });
        }
