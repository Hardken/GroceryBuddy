...
import com.example.grupo10.databinding.ActivityMapaBinding;
...
public class MapaActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private Button btn_aceptar_ubicarion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_aceptar_ubicarion = findViewById(R.id.btn_aceptar_ubicacion);

        btn_aceptar_ubicarion.setOnClickListener(new View.OnClickListener() {
            @Override
...
// Construct a CameraPosition focusing on Mountain View and animate the camera to that position.
        ...
        mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(@NonNull LatLng latLng) {
                ...
                btn_aceptar_ubicarion.setEnabled(true);
